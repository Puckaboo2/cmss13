...
#define FACTION_LIST_ARES_MARINE list(FACTION_LIST_MARINE, FACTION_ARES)
#define FACTION_LIST_ARES_ALL list(FACTION_ARES, FACTION_LIST_UA, FACTION_LIST_WY)
#define FACTION_LIST_ARES_WY list(FACTION_ARES, FACTION_LIST_WY)
#define FACTION_LIST_ARES_UA list(FACTION_ARES, FACTION_LIST_UA)
