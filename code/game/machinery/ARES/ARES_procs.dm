...
/datum/ares_link
	...
	var/list/faction_options = list("USCM Only" = FACTION_LIST_ARES_MARINE, "USCM and CMB Only" = FACTION_LIST_ARES_UA, "Wey-Yu Only" = FACTION_LIST_ARES_WY, "USCM, CMB, and Wey-Yu" = FACTION_LIST_ARES_ALL, "ARES Only" = FACTION_LIST_ARES_ALONE)
